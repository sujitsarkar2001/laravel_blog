                            ...
                            <tbody>
                                ...
                                @foreach ($subscriber as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger waves-effect" type="button" onclick="deleteSubscriber({{ $row->id }})">
                                                <i class="material-icons">delete</i>
                                            </button>
                                            <form id="delete-form-{{$row->id}}" action="{{route('admin.subscriber.destroy', $row->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
